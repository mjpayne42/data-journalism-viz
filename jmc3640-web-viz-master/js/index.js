  ...
  let barChartConfig = {
    ...
    data: {
      ...
      datasets: [ {
        ...
        label: "Contributions from Individual Donors",
        borderColor: "#8e5ea2",
        backgroundColor:  "#8e5ea2",
        fill: false
      },
      {
        ...
        label: "Contributions from Committees",
        borderColor: "#3cba9f",
        backgroundColor:  "#3cba9f",
        fill: false
      },
    ...
    options: {
      title: {
        display: true,
        text: 'Campaign contributions to state lawmakers from Johnson County (in USD)'
      },
      scales: {yAxes: [
        { ticks: {
            min: 0,
